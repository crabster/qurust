...
fn main() {
    ...
    // TODO: Unfortunately there are some bugs in antlr4rust that creates some errors in the
    // generated files, which so far have been fixed manually. The following commands are a
    // workaround until the these bugs are fixed.
